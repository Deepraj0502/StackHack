    ...
    >
      ...
      <div className="mt-10 flex flex-col gap-3">
        <div
          className={
            props.selected === "Dashboard"
              ? "flex gap-2 items-center rounded-md bg-[#2c5cff] p-2 py-3 cursor-pointer"
              : "flex gap-2 items-center rounded-md hover:bg-[#171b2b] p-2 py-3 cursor-pointer"
          }
          onClick={() => {
        ...
        >
          ...
          <p className="text-sm md:text-md font-semibold">Dashboard</p>
        </div>
        <div
          className={
        ...
        >
          <FaUser className="w-5 h-5 md:w-5 md:h-5" />
          <p className="text-sm md:text-md font-semibold">Users</p>
        </div>
        <div
          className={
        ...
        >
          ...
          <p className="text-sm md:text-md font-semibold">Movies</p>
        </div>
        <div
          className={
        ...
        >
          ...
          <p className="text-sm md:text-md font-semibold">Theaters</p>
        </div>
        <div
        ...
        >
          ...
          <p className="text-sm md:text-md font-semibold">Logout</p>
        </div>
      </div>
    </div>
  );
